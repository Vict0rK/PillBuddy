...
| NADHIRAH BINTI AYUB KHAN                | - Designed and implemented weight sensor logic <br> - Integrated RFID module for medication verification <br> - Calibrated the weight sensor to ensure accurate dosage measurements <br> - Handled communication between the weight sensor and the frontend using MQTT       |
