...
| MICHELLE MAGDALENE TRISOERANTO          |  - Developed placeholder buzzer logic triggered on face detection, during scheduled medication times, to simulate unauthorized access  <br> - Implemented ultrasonic sensor logic to detect box open/close states <br> - Designed the initial alert logic to coordinate Twilio, MQTT messaging, and sensor actions <br> - Handled hardware interfacing, soldered components for hardware setup, and assembled the physical prototype of the medication box <br> - Assisted in refining frontend features related to dashboard and notifications for better user experience                                             |
| NADHIRAH BINTI AYUB KHAN                | - Designed and implemented weight sensor logic <br> - Integrated RFID module for medication verification <br> - Calibrated the weight sensor to ensure accurate dosage measurements <br> - Handled communication between the weight sensor and the frontend using MQTT <br> - Handled hardware interfacing and assembled the physical prototype of the medication box      |
