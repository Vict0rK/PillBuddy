...
| ----------------------------------------| -------------------------------------------- |
| KONG TENG FOONG VICTOR                  |   - Developed and implemented text detection module <br> - Integrated Weight Sensor, RFID monitor and text detection to trigger/deactivate and publish to web server.     |
