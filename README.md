...
| ----------------------------------------| -------------------------------------------- |
| KONG TENG FOONG VICTOR                  |   - Developed and implemented text detection module <br> - Integrated Weight Sensor, RFID monitor and text detection to trigger/deactivate and publish MQTT to web server and other Pis. <br> - Calibrated text detection perimeter to have the best detection accuracy <br> - Implemented MQTT on web server to retrieve alerts and display onto logs <br> - Integrated Twilio messaging from front-end to mobile device.    |
