...
| ----------------------------------------| -------------------------------------------- |
| KONG TENG FOONG VICTOR                  |   - Developed and implemented text detection module <br> - Integrated Weight Sensor, RFID monitor and text detection to trigger/deactivate and publish MQTT to web server and other Pis. <br> Calibrated text detection perimeter to have the best detection accuracy <br> - Implemented MQTT on web server to retrieve alerts and display onto logs <br> - Integrated Twilio messaging from front-end to mobile device. <br> Assembling medication box    |
| LAM JUN XIAN, AARON                     |  - Designed and implemented facial recognition module <br> - Modularised ultrasonic and buzzer into modules <br> - Integrated ultrasonic, buzzer, and facial recognition modules to trigger/deactivate functions and publish MQTT messages to other Pis <br> - Implemented smoothing and calibration of ultrasonic sensor module <br> - Implemented medication box setup (publishing information to edge pis) from web server<br> | 
| LOW YI SAN                              |  - Developed and implemented the web dashboard using React (frontend) and Flask (backend).<br> - Integrated MongoDB Atlas for data storage and management<br>  - Dockerized the entire dashboard, including the frontend, backend, and MongoDB Atlas, and hosted it on the Raspberry Pi web server<br>- Created APIs for medication box setup, logs, weekly adherence graph, and statistics<br> - Produced the project video and poster |
| MICHELLE MAGDALENE TRISOERANTO          |  - Developed placeholder buzzer logic triggered on face detection, during scheduled medication times, to simulate unauthorized access  <br> - Implemented ultrasonic sensor logic to detect box open/close states <br> - Designed the initial alert logic to coordinate Twilio, MQTT messaging, and sensor actions <br> - Determined GPIO pin assignments, soldered components for hardware setup, and assembled the physical prototype of the medication box <br> - Assisted in refining frontend features related to dashboard and notifications for better user experience                                             |
| NADHIRAH BINTI AYUB KHAN                | - Designed and implemented weight sensor logic <br> - Integrated RFID module for medication verification <br> - Calibrated the weight sensor to ensure accurate dosage measurements <br> - Handled communication between the weight sensor and the frontend using MQTT <br> - Determined GPIO pin assignments and assembled the physical prototype of the medication box      |
